                    ...
                    <div>
                        <ol class="breadcrumb info_breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('useful-info') }}">Полезная
                                    информация</a></li>
                            <li class="breadcrumb-item active">Тестирование</li>
                        </ol>
                    </div>
                    <div class="info_item">
                        <div class="info_item_title">
                            <h5 class="underline">
                                Тестирование по русскому языку, истории и законодательству РФ для оформления разрешения на
                                работу
                            </h5>
                        </div>
                        <div class="info_item_img">
                            <img src="/storage/info/pass4.jpg" alt="Sertifikat">
                        </div>
                        <div class="info_item_content">
                            <p>С 1 января 2015 года, каждый иностранный гражданин, желающий получить трудовой патент,
                                разрешение на работу или вид на жительство, обязан пройти тестирование по русскому языку,
                                истории и праву.</p>
                            ...
                            <ol>
                                ...
                                <li class="li_padding">Документ государственного образца об образовании (на уровне не ниже
                                    основного общего
                                    образования), выданным образовательным учреждением на территории государства, входившего
                                    в состав СССР, до 1 сентября 1991 года;</li>
                            ...
                            <h3>Для прохождения тестирования необходимы следующие документы:</h3>
                            <ul>
