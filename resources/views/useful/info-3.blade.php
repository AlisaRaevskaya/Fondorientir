                ...
                <div class="col-md-9">
                    <div class="">
                        ...
                        <p><span class="f-size15"><strong>
                            ...
                            который
                            выдается
                            <strong>ГУ МВД </strong>физическому или юридическому лицу для того, чтобы иностранный гражданин
                            смог
                            оформить
                            визу и
                            приехать в Россию.
                        ...
                        <p>В свою очередь и сами приглашения различаются между собой, как раз на основании целей приезда.
                        </p>
                        ...
                        <ul>
                            ...
                            <li class="li_padding"><strong>Коммерческое</strong> &ndash; выдается компании для приглашения
                                иностранных
                                специалистов
                                именно в
                            ...
                            <li class="li_padding"><strong>Деловое</strong> &ndash; выдается организации для приглашения
                                ...
                                целях
                                (переговоры);</li>
                            <li class="li_padding"><strong>Рабочее</strong> &ndash; выдается работодателю для приглашения
                                иностранных
                                специалистов
                                для
                                работы в
                        ...
                        <p class="f-size15"><strong>Документы для оформления частного приглашения физическому лицу </strong>
                        </p>
                        ...
                        <p class="f-size15"><strong>Документы для оформления коммерческого/делового приглашения юридическому
                                лицу </strong>
                        </p>
                    ...
                    <div class="">
                        ...
                        <p>Бывают ситуации, когда Вы приглашаете иностранного гражданина на переговоры/встречу/обслуживание
                            ...
                            ли
                            это?</p>
                        <p>Сделать это можно только, если приглашение выдано на формализованном бланке МВД (не электронное).
                        </p>
                        <img src="{{ asset('storage/button3.png') }}" alt="consulation-button.jpg" class=" img-responsive"
