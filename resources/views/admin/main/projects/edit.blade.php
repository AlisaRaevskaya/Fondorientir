                            ...
                            <div class="card card-outline card-info">
                                ...
                                <div class="card-body">
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item">
                                            <a class="nav-link " data-toggle="tab" href="#content">Содержание</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="box tab-content">
                                        ...
                                        <div class="box-body tab-pane active" id="projects">
                                            <div style="margin-top:15px;">
                                                <div class="col-md-12">
                                                    <table class="table table-bordered table-responsive border-top">
                                                        <thead>
                                                            <tr style="color:black;font-weight:bold;">
                                                                <th scope="col">№</th>
                                                                <th scope="col">Период выполнения
                                                                </th>
                                                                ...
                                                                <tr style="color:black;">
                                                                    ...
                                                                    <td style="width:16.66%" ;>
                                                                        <form
                                                                            ...
                                                                            {{ method_field('DELETE') }}
                                                                            <button type="submit"
                                                                                class="btn btn-danger click-warning"><i
                                                                                    class="fa fa-trash"></i>
                                                                                Удалить</button>
                                                                        </form>
                                                                    </td>
