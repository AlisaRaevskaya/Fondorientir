...
<div class="" > <a href="{{route('admin.structure.update', $page->id)}}"class="btn btn-primary pull-right">Сохранить</a></div>
<div class=""><a href="{{route('admin.structure.show',$page->id)}}"class="btn btn-warning pull-right">Просмотр</a></div>
