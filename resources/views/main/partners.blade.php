                ...
                <div class="col-md-9">
                    ...
                    <div class="entity-wrapper">
                        ...
                        <div class="entity_content partners">
                            ...
                            <div class="m30 partners_div">
                                <a href="https://www.ranepa.ru/">
                                    <img class="img-responsive partners_div_img"
                                        src="{{ asset('storage/partners/ranhais.jpg') }}" alt="ranhais.png"></a>
                            ...
                            <div class="partners_div partner_items">
                                <a href="https://spb.ranepa.ru/">
                                    <img class="img-responsive partners_div_img"
                                        src="{{ asset('storage/partners/ran.png') }}" alt="ranhais.jpg"></a>
                                <div class="m30">
                                ...
                                <div class="partner_blocks">
                                    ...
                                    <div class="partner_block">
                                        <a href="https://archiveslo.ru/">
                                            <img src="{{ asset('storage/partners/archiv.png') }}"
                                                class="img-responsive partner_block_img" alt="ranhais.jpg"></a>
                                    ...
                                    <div class="partner_block">
                                        <a href="https://www.spbgik.ru/">
                                            <img class="img-responsive partner_block_img"
                                                src="{{ asset('storage/partners/logo_5.png') }}" alt="spbgik.jpg"></a>
                                        <p>Санкт-Петербургский государственный институт культуры</p>
                                    </div>
                                    <div class="partner_block ">
                                        <a href="https://lengu.ru/">
                                            <img class="img-responsive partner_block_img"
                                                src="{{ asset('storage/partners/lengu.png') }}" alt="lengu.jpg"></a>
                                    ...
                                    <div class="partner_block ">
                                        <a href="https://spbu.ru/">
                                            <img class="img-responsive partner_block_img"
                                                src="{{ asset('storage/partners/ranhais.png') }}" alt="ranhais.jpg"></a>
                                        <p>
                                    ...
                                    <div class="partner_block ">
                                        <a href="https://www.gup.ru/">
                                            <img class="img-responsive partner_block_img"
                                                src="{{ asset('storage/partners/gup.png') }}" alt="gup.jpg"></a>
                                        <p>Санкт-Петербургский Гуманитарный университет профсоюзов</p>
                                    </div>
                                    <div class="partner_block">
                                        <a href="https://www.spbstu.ru/">
                                            <img class="img-responsive partner_block_img"
                                                src="{{ asset('storage/partners/politech.jpg') }}" alt="politech.jpg"></a>
                                    ...
                                    <div class="partner_block">
                                        <a href="http://spp.spb.ru/">
                                            <img class="img-responsive partner_block_img"
                                                src="{{ asset('storage/partners/spp.jpg') }}" alt="spp.jpg"></a>
                                    ...
                                    <div class="partner_block">
                                        <div class="flex-row">
                                            <img class="img-responsive partner_block_img"
                                                src="{{ asset('storage/partners/rspp.png') }}" alt="rspp.jpg">
                                            <a href="http://len.rspp.ru/">
                                                <img class="img-responsive partner_block_img"
                                                    src="{{ asset('storage/partners/img2.png') }}" alt="ranhais.jpg"></a>
                                        </div>
            ...
            <div class="col-md-9">
                ...
                <div class="entity-wrapper">
                    ...
                    <div class="entity_content partners">
                        ...
                        <div class="m30">
                            <a href="https://www.ranepa.ru/">
                                <img class="img-responsive" src="/storage/partners/ranhais.jpg" alt="ranhais.png" title="Российская академия народного хозяйства и государственной
                                                                            службы при Президенте
                        ...
                        <div class="partner_items">
                            <a href="https://spb.ranepa.ru/">
                                <img class="img-responsive" src="/storage/partners/ran.png" alt="ranhais.jpg"
                                    title="РАНХиГС"></a>
                            <div class="m30">
                                <p>СПб ГКУ "Санкт-Петербургский Дом национальностей"</p>
                                <p>СПб ГАУ "Центр трудовых ресурсов"</p>
                            ...
                            <div class="partner_blocks">
                                <div class="partner_block">
                                    <a href="https://archiveslo.ru/">
                                        <img src="/storage/partners/archiv.png" class="img-responsive" alt="ranhais.jpg"
                                            title="Архивное управление Ленинградской области"></a>
                                    <p>Архивное управление Ленинградской области</p>
                                </div>
                                <div class="partner_block">
                                    <a href="https://archive.pskov.ru/ob-upravlenii/gosudarstvennyy/gosudarstvennyy">
                                        <img class="img-responsive" src="/storage/partners/archivspb.png"
                                            alt="ranhais.jpg" title="Государственный архив Псковской области"></a>
                                    <p>Государственный архив Псковской области </p>
                                </div>
                                <div class="partner_block">
                                    <a href="https://www.herzen.spb.ru/"><img class="img-responsive"
                                            src="/storage/partners/gerzena.png" alt="gerzena.jpg"
                                            title="Российский государственный педагогический университет им. А. И. Герцена"></a>
                                    <p>Российский государственный педагогический университет им. А. И. Герцена </p>
                                </div>
                                <div class="partner_block ">
                                    <img class="img-responsive" src="/storage/partners/center_politiki.jpg"
                                        alt="center_politiki.jpg"
                                        title="Некоммерческое партнерство 'Центр социально-консервативной политики'">
                                    <p>Некоммерческое партнерство "Центр социально-консервативной политики"</p>
                                </div>
                                <div class="partner_block">
                                    <a href="https://www.spbgik.ru/">
                                        <img class="img-responsive" src="/storage/partners/spbgik.png" alt="spbgik.jpg"
                                            title="Санкт-Петербургский государственный институт культуры"></a>
                                    <p>Санкт-Петербургский государственный институт культуры</p>
                                </div>
                                <div class="partner_block">
                                    <a href="http://cskp.ru/ ">
                                        <img class="img-responsive" src="/storage/partners/fond.jpg" alt="fond.jpg"
                                            title="Фонд президентских грантов"></a>
                                    <p>Фонд президентских грантов </p>
                                </div>

                                <div class="partner_block ">
                                    <a href="https://lengu.ru/">
                                        <img class="img-responsive" src="/storage/partners/lengu.png" alt="lengu.jpg"
                                            title="Ленинградский государственный университет имени А.С.Пушкина"></a>
                                    <p>Ленинградский государственный университет имени А.С.Пушкина</p>
                                </div>
                                <div class="partner_block ">
                                    <a href="https://spb.hse.ru/ "><img class="img-responsive"
                                            src="/storage/partners/spbu.png" alt="rskola_ekonomik.jpg"
                                            title="Санкт-Петербургский государственный университет"></a>
                                    <p>Санкт-Петербургский государственный университет</p>
                                </div>
                                <div class="partner_block ">
                                    <a href="https://spb.hse.ru/ "><img class="img-responsive"
                                            src="/storage/partners/skola_ekonomiki1.png" alt="rskola_ekonomik.jpg"
                                            title="Университет «Высшая школа экономики»"></a>
                                    <p>Национальный исследовательский университет «Высшая школа экономики»</p>
                                </div>
                                <div class="partner_block ">
                                    <a href="https://spbu.ru/">
                                        <img class="img-responsive" src="/storage/partners/ranhais.png"
                                            alt="ranhais.jpg"
                                            title="Санкт-Петербургский государственный университет"></a>
                                    <p>
                                        Санкт-Петербургский государственный университет
                                ...
                                <div class="partner_block">
                                    <a href="https://www.gup.ru/">
                                        <img class="img-responsive" src="/storage/partners/gup.png" alt="gup.jpg"
                                            title="Санкт-Петербургский Гуманитарный университет профсоюзов"></a>
                                    <p>Санкт-Петербургский Гуманитарный университет профсоюзов</p>
                                </div>
                                <div class="partner_block">
                                    <a href="https://www.spbstu.ru/">
                                        <img class="img-responsive" src="/storage/partners/politech.jpg"
                                            alt="politech.jpg"
                                            title="Санкт-Петербургский политехнический университет Петра Великого"></a>
                                    <p>Санкт-Петербургский политехнический университет Петра Великого</p>
                                </div>
                                <div class="partner_block">
                                    <a href=""><img class="img-responsive" src="/storage/partners/scenter.jpg"
                                            alt="scenter.jpg" title="Центр социально-консервативной политики
                                                                        'Северо-Запад'"></a>
                                    <p>Некоммерческое партнерство "Центр социально-консервативной политики
                                        "Северо-Запад"
                                    </p>
                                ...
                                <div class="partner_block">
                                    <a href="http://spp.spb.ru/">
                                        <img class="img-responsive" src="/storage/partners/spp.jpg" alt="spp.jpg"
                                ...
                                <div class="partner_block">
                                    <div class="flex-row">
                                        <img class="img-responsive" src="/storage/partners/rspp.png" alt="rspp.jpg"
                                            title="">
                                        <a href="http://len.rspp.ru/">
                                            <img class="img-responsive" src="/storage/partners/img2.png"
                                                alt="ranhais.jpg"
                                                title="«Союз промышленников и предпринимателей Ленинградской области»"></a>
                                    </div>
                                    <p class="text-center">Региональное объединение работодателей
                                        «Союз промышленников <br>и предпринимателей Ленинградской области»
                                    </p>
                                ...
                                <div class="partner_block">
                                    <a href=""><img class="img-responsive"
                                            src="/storage/partners/grazdan_dostoinstvo.jpg"
